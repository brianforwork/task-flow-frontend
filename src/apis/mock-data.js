  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        cards: [
          { _id: 'column-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-03', FE_PlaceholderCard: true, title: 'Placeholder Card', description: null, cover: null, memberIds: [], comments: [], attachments: [] }
        ]
      }
      // {
      //   _id: 'column-id-04',
